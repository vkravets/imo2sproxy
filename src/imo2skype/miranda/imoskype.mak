...
ALL : "\temp\debug\imo.im\bin\imo2sproxy.exe" "$(OUTDIR)\imoskype.bsc"
...
CLEAN :
	...
	-@erase "\temp\debug\imo.im\bin\imo2sproxy.exe"
...
"\temp\debug\imo.im\bin\imo2sproxy.exe" : "$(OUTDIR)" $(DEF_FILE) $(LINK32_OBJS)
    $(LINK32) @<<
